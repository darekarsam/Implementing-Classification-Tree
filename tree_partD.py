...
def perform10FoldValidation(dataset,criteria,cols):
  ...
  for i in range (1,11):
    ...
    classCount=len(dataset["ClassOfT"].unique().tolist())
    noOfattr=len(cols)
    logClass=mth.log(classCount,2)
    logattr=mth.log(noOfattr,2)
    lenTraining=len(trainingDataset)
    error=totalNoOfPrediction-correctPrediction
    logTrain=mth.log(lenTraining,2)
    MDL=(nonLeafCount*logClass)+(leafCount*logattr)+(error*logTrain)
    print "For Fold {0}: Minimum description length is {1}".format(i,MDL)
...
For Fold 1: Minimum description length is 306.974565214
In Proces for Fold  2
For Fold 2: 48 predicted correctly out of 68
For Fold 2: Minimum description length is 237.450921926
In Proces for Fold  3
For Fold 3: 41 predicted correctly out of 68
For Fold 3: Minimum description length is 309.625435847
In Proces for Fold  4
For Fold 4: 31 predicted correctly out of 68
For Fold 4: Minimum description length is 417.926084306
In Proces for Fold  5
For Fold 5: 34 predicted correctly out of 68
For Fold 5: Minimum description length is 405.819499776
In Proces for Fold  6
For Fold 6: 52 predicted correctly out of 68
For Fold 6: Minimum description length is 246.441642562
In Proces for Fold  7
For Fold 7: 48 predicted correctly out of 68
For Fold 7: Minimum description length is 290.829871946
In Proces for Fold  8
For Fold 8: 58 predicted correctly out of 68
For Fold 8: Minimum description length is 205.548773496
In Proces for Fold  9
For Fold 9: 46 predicted correctly out of 68
For Fold 9: Minimum description length is 324.033761643
In Proces for Fold  10
For Fold 10: 57 predicted correctly out of 70
For Fold 10: Minimum description length is 247.953567003
