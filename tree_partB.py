...
def perform10FoldValidation(dataset,criteria,cols):
  ...
  for i in range (1,11):
    ...
    for j in range(0,len(y_pred)):
      diff=diff+abs(y_true[j]-y_pred[j])
...
For Fold 1: 46 predicted correctly out of 68
In Proces for Fold  2
For Fold 2: 52 predicted correctly out of 68
In Proces for Fold  3
For Fold 3: 64 predicted correctly out of 68
In Proces for Fold  4
For Fold 4: 56 predicted correctly out of 68
In Proces for Fold  5
For Fold 5: 60 predicted correctly out of 68
In Proces for Fold  6
For Fold 6: 62 predicted correctly out of 68
In Proces for Fold  7
For Fold 7: 64 predicted correctly out of 68
In Proces for Fold  8
For Fold 8: 64 predicted correctly out of 68
In Proces for Fold  9
For Fold 9: 62 predicted correctly out of 68
In Proces for Fold  10
For Fold 10: 66 predicted correctly out of 70
Average Accuracy is : 0.873900293255

#output for Information Gain
Enter 1 for GINI or 2 for Information Gain : 2
In Proces for Fold  1
For Fold 1: 54 predicted correctly out of 68
In Proces for Fold  2
For Fold 2: 60 predicted correctly out of 68
In Proces for Fold  3
For Fold 3: 64 predicted correctly out of 68
In Proces for Fold  4
For Fold 4: 54 predicted correctly out of 68
In Proces for Fold  5
For Fold 5: 52 predicted correctly out of 68
In Proces for Fold  6
For Fold 6: 62 predicted correctly out of 68
In Proces for Fold  7
For Fold 7: 62 predicted correctly out of 68
In Proces for Fold  8
For Fold 8: 62 predicted correctly out of 68
In Proces for Fold  9
For Fold 9: 66 predicted correctly out of 68
In Proces for Fold  10
For Fold 10: 66 predicted correctly out of 70
Average Accuracy is : 0.882697947214
